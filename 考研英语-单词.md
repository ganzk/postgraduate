...
found a broad consensus 达成广泛的共识  sence
...
> application 涂抹
>
> appliance  applicant   job applicant   job-seeker   job-hunter
>
> cosmetics 化妆品
>
> cos-  打扮   costume
...
> pro- 向前 往前推（动作）
>
> pri- （地位） pre- （时间） prepaid
>
> progress  进步 进展  provoke  激进 引起  voke vok  voc  voice 
>
...
host 主人 主机 localhost 本地主机

generate additional revenue 产生额外的收入

generate electricity 发电

generation n.产生  generative adj.生成的
...
the members of any other professions其他任何行业的从业人员
...
specialist  specialty   expertise
...
n.预期；期望；指望 t变名词  = ation

It fell short ofthe latter's expectations.它未达到后者的期望。 
...
the game unveiled tonight

based adj.以... 为重要部分（或特征）的；以.... 为基础的

a class-based community
...
disorganized data collection杂乱无章的数据收集
...
change the mindset ofthe academic community 改变学术界的思维模式 
...
outcome  income  expense/expenditure
...
age limit年龄限制     the limits of our patience我们耐心的极限 
...
novelty  innovation  innovate   renovate
...
the geological theory about drifting plates 地质学上的板块漂移说
